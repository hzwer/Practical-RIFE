...
For anime scenes, it is recommended to choose 4.22.lite-21M, and for real scenes, it is recommended to choose 4.18.

4.25beta - 21M - 2024.09.19 | [Google Drive](https://drive.google.com/file/d/10RhXyyEBY38NDotjwBG6sRH3VM3WAJ_O/view?usp=share_link) | I am trying using more flow blocks, so the scale_list will change accordingly.
